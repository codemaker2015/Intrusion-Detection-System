...
import classifier_package.Evaluation2;
 ...
 * @author jojoj
 */
public class BaggingEvaluation extends javax.swing.JFrame {

    /**
     * Creates new form BaggingEvaluation
     */
    public BaggingEvaluation() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Perform Bagging Evaluation");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Duration", "Protocol_Type", "Service", "Flag", "Src_Bytes", "Dst_Bytes", "Land", "Wrong_Fragnitinuous", "Urgent", "Hot", "Num_Failed_Logins", "Logged_In", "Num_Compromised", "Root_Shell", "Su_Attempt", "Num_Root", "Num_file_creations", "Num_shells", "Num_access_files", "Num_outbound_cmds", "Is_host_login", "Is_guest_login", "Count", "Srv_count", "Serror_rate", "Srv_serror_rate", "Rerror_rate", "Srv_rerror_rate", "Same_srv_rate", "Diff_srv_rate", "Srv_diff_host_rate", "Dst_host_count", "Dst_host_srv_count", "Dst_host_same_srv_rate", "Dst_host_diff_srv_rate", "Dst_host_same_src_port_rate", "Dst_host_srv_diff_host_rate", "Dst_host_serror_rate", "Dst_host_srv_serror_rate", "Dst_host_rerror_rate", "Dst_host_srv_rerror_rate", "Class"
            }
        ) {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jButton1))
                .addGap(18, 18, 18)
                .addComponent(jFileChooser1, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            e.mainmenu("weka.classifiers.meta.Bagging"," ","-t","train.csv","-split-percentage",""+percentage,"-preserve-order","-classifications","weka.classifiers.evaluation.output.prediction.PlainText");
            ...
            File f1 = new File("F:\\Project\\Intrusion_Detection_System_MA\\bagging_eval.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BaggingEvaluation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BaggingEvaluation().setVisible(true);
            }
        });
    }
